 ...
 * @returns {Promise}
 */
exports.withTimeout = (promise, timeout) =>
 ...
 * @returns {Promise}
 */
exports.asyncMap = (array, fn, options) =>
  co(function*() {
 ...
 * @returns {Promise}
 */
exports.asyncForEach = (array, fn, options) =>
  co(function*() {
    options = Object.assign({}, defaultAsyncArrayProcessOptions, options);
...
exports.Worker = class Worker {
  ...
  constructor(processItemFn, threads, options) {
    ...
    if (!isNat(threads)) throw new Error('threads must be a positive integer');
